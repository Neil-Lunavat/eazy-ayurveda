...
export const aboutUsContent =
    "At Eazy Ayur-Veda, our journey began with a simple belief: if it's good enough for our family, it's good enough for yours. From carefully crafting home remedies in our kitchens to bringing nature's purest solutions to you, we are committed to blending tradition with trust. Our products are rooted in the wisdom of Ayurveda, ensuring that every ingredient serves a purpose - nourishing, strengthening, and healing naturally. With a passion for holistic wellness, we don't just offer bold products; we bring you remedies that stand the test of time. Because true wellness starts at home.";
